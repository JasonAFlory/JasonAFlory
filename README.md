...
**Senior macOS & Endpoint Engineer** | Jamf · Automation · Cloud · Compliance

15+ years building secure, audit-ready Apple platforms with Jamf in regulated and enterprise environments. Grew a global Mac estate from 1,500 to 8,000+ devices across 80+ sites (Hogarth Worldwide/WPP), including a Jamf Cloud migration and estate-wide SOC 2 compliance support. Available now for contract or permanent work, UK-based or remote.
...
Currently building infrastructure-as-code depth in Terraform/Jamf.
